...
import { LogOut, Loader2, AlertCircle, MessageSquare, Bot } from "lucide-react"
import {
	AlertDialog,
	AlertDialogAction,
	AlertDialogCancel,
	                        ...
	                        <TooltipProvider>
	                                <div className="flex h-screen bg-background text-foreground overflow-hidden selection:bg-primary/20">
	                                        ...
	                                        <div className="fixed bottom-6 right-6 z-50 pointer-events-none md:bottom-8 md:right-8">
	                                                <div className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold border shadow-xl backdrop-blur-md pointer-events-auto transition-all duration-500 ${
	                                                        isConnected
