...
interface CronDeleteAllModalProps {
        open: boolean
        onOpenChange: (open: boolean) => void
        onConfirm: () => void
}

export function CronDeleteAllModal({ open, onOpenChange, onConfirm }: CronDeleteAllModalProps) {
        return (
                        ...
                        <AlertDialogContent className="rounded-[2rem] border-border/40 max-w-md">
                                <AlertDialogHeader>
                                        <div className="flex items-center gap-3 text-destructive mb-2">
                                                ...
                                                <AlertDialogTitle className="text-2xl font-black">Nuke All Jobs?</AlertDialogTitle>
                                        </div>
                                        <AlertDialogDescription className="text-base">
                                                You are about to delete **EVERY** scheduled cron job in the system. This is a destructive operation and cannot be reversed.
                                        </AlertDialogDescription>
                                </AlertDialogHeader>
