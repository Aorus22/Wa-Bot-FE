	...
	const handleTest = async () => {
		try {
			...
			setConsoleLogs(prev => [...prev, {
				...
				type: 'invoke',
				message: 'Starting cron simulation...'
			}])
				...
				<div className="flex items-start gap-3 min-w-0">
					...
					<div className="min-w-0">
						<h1 className="text-xl md:text-2xl font-semibold tracking-tight truncate">
							{formData.name || 'Untitled Cron Job'}
						</h1>
				...
				<div className="mx-auto w-full max-w-6xl px-4 md:px-8 py-6 md:py-8">
					...
					<Card className="mb-6">
						<CardHeader className="border-b border-border/40 pb-5">
							...
							<CardDescription>Basic configuration for your scheduled task.</CardDescription>
						</CardHeader>
						<CardContent className="space-y-5">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
								<div className="space-y-2">
									...
									<Input
										placeholder="e.g., Daily Broadcast"
										value={formData.name}
			...
			>
				...
				<div className="flex items-center justify-between px-4 md:px-6 py-2.5 bg-[#181818] border-b border-[#2a2a2a] shrink-0">
					<div className="flex items-center gap-2.5">
						...
						<span className="text-sm font-medium text-[#e0e0e0]">Cron Debugger Active</span>
					</div>
					<div className="flex items-center gap-2">
						<Button
							variant="ghost"
				...
				<div className="flex flex-1 overflow-hidden">
					{/* Left Pane: Schedule Info + Run Button */}
					<div className="flex flex-col flex-[0.8] border-r border-[#2a2a2a] min-w-0">
						...
						<div className="flex-1 p-4 overflow-y-auto">
							<div className="space-y-3">
								<div>
									<div className="text-[10px] font-mono uppercase tracking-[0.05em] text-[#666] mb-1">Schedule</div>
									<div className="font-mono text-sm text-[#d0d0d0] bg-[#252525] rounded-md px-3 py-2 border border-[#333]">
										{formData.schedule || 'Not set'}
									</div>
								</div>
								<div>
									<div className="text-[10px] font-mono uppercase tracking-[0.05em] text-[#666] mb-1">Task</div>
									<div className="font-mono text-sm text-[#d0d0d0] bg-[#252525] rounded-md px-3 py-2 border border-[#333] truncate">
